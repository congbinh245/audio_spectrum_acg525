...
/*	parameter real g=0.077,0.090,0.095,0.100,0.105,0.110
	parameter real a=0.698,0.688,0.684,0.680,0.677,0.673
	parameter delta_T=1579,1949,2113,2293,2467,2647
*/
//	parameter delta_T=2647;
//----------------------- ---------------------------
    parameter DW=16;
...
always @(posedge clk or negedge rst_n)begin
if(~rst_n)RdEnx=1'b0;
else if(Wnumx>=718)RdEnx=1'b1;
else RdEnx=1'b0;
end
	fifo_sc_top comb6_FIFOx(
...
//    sig_delay#(DW,1)comb6x1_delay1(clk,rst_n,x1,x1_d1);
...
//1001 0b01 0b01
    ...
    {{4{x1_d1[DW-1]}},x1_d1,8'b0}+
    {x1_d1[DW-1],x1_d1,11'b0};
//x1(t)=x2(t)+g*x1(t-1),其中g=0.110,量化后g=450.5600=451=1_1100_0011=csd0_0b00_010b
	
//x2=(din+a*x1_dd),a=0.673,量化a=2756.6=2757=1010_1100_0101=csd0b0b_0b00_0101
//0010 000b 00b0
//0100 1001 0001
//00b0 b00b 0001
	assign X2=X+
