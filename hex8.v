...
//8位循环移位寄存器
	...
	always@(*)
		case(data_tmp)
			...
			4'h2:seg = 7'b0100100;
			4'h3:seg = 7'b0110000;
			4'h4:seg = 7'b0000110; //E
			4'h5:seg = 7'b0011000; //q
			4'h6:seg = 7'b1000001; //U
			4'h7:seg = 7'b0001000; //A
			4'h8:seg = 7'b1001110; //r
			4'h9:seg = 7'b0000011; //b
			4'ha:seg = 7'b0010010; //S
			4'hb:seg = 7'b1000110; //C
			4'hc:seg = 7'b0001001; //H
            4'hd:seg = 7'b0100001; //d
			4'he:seg = 7'b0001100; //P
			4'hf:seg = 7'b1111111; //null
		endcase
